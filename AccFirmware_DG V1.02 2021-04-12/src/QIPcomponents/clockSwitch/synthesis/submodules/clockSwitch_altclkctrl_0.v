//altclkctrl CBX_SINGLE_OUTPUT_FILE="ON" CLOCK_TYPE="AUTO" DEVICE_FAMILY="Arria V" USE_GLITCH_FREE_SWITCH_OVER_IMPLEMENTATION="ON" clkselect ena inclk outclk
...
//synthesis_resources = arriav_clkena 1 reg 2 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  clockSwitch_altclkctrl_0_sub
	( 
	clkselect,
	ena,
	inclk,
...
endmodule //clockSwitch_altclkctrl_0_sub
...
`timescale 1 ps / 1 ps
// synopsys translate_on
module  clockSwitch_altclkctrl_0  (
    clkselect,
    inclk0x,
    inclk1x,
    outclk);
...
`endif
    ...
    clockSwitch_altclkctrl_0_sub  clockSwitch_altclkctrl_0_sub_component (
                .clkselect (sub_wire2),
                .ena (sub_wire4),
                .inclk (sub_wire6),
                .outclk (sub_wire0));
